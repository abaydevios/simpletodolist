        ...
        NavigationView {
            VStack {
                ...
                Button("Save") {
                    ...
                    .clipShape(RoundedRectangle(cornerRadius: 10.8, style: .continuous))
                ...
                List {
                    ...
                    ForEach(allTasks) { task in
                        HStack {
                            ...
                            Text(task.title ?? "" )
                            Spacer()
                            Image(systemName: task.isFavorites ? "heart.fill": "heart")
                                .foregroundColor(.red)
                                .onTapGesture {
                                    updateTask(task)
                                }
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        let persistedContainer = CoreDateManager.shared.persistentContainer
